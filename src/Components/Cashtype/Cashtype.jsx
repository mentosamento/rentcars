...
import {changeMarka, changeModel, changeCity, changeMinYear, changeMaxYear, changeBan, changeColor, changeOwnerType, changeMaxPrice, changeMinPrice}  from '../../features/search';
    ...
    return (
        <div className='counters-container'>
            <div className='max-container count-container'>
                <input className='inputs' value={value} placeholder='Min.qiymət' type='text' onKeyDown={handleKeyDown} />
            </div>
            <div className='min-container count-container'>
                <input className='inputs' value={maxValue} placeholder='Max.qiymət' type='text' onKeyDown={MaxhandleKeyDown}/>
            </div>
        </div>
    );
}
